...
class Individual:
    ...
    def create_gene(self):  # gives gene to the individual - i.e. route
        ...
        while i < n-1:          # 0 is already added in route, hence find n-1 elements.
            ls_all = np.nonzero(theMap[self.route[i]])  # should be accessed as possible_vertices[0], because its 0th element consists of the tuple
    ...
    def genetic_algorithm(self):
        ...
        for i in range(0, no_of_iterations):  # 1. run GA for given no of iterations
            ...
            for i in self.new_population.populationList:
                print(i.route, "\td: ", i.distance, "\t: ", i.fitness)
            ...
            for crossoverIteration in range(0, no_of_couples):
                ...
                self.new_population.populationList.append(parent01)  # Step 4. Elitism
                self.new_population.populationList.append(parent02)
